...
class ChatServer:
    def __init__(self, host='127.0.0.1', port=200):
        ...
        print("/lista - lista usuários online")
    ...
    def process_command(self, client, message):
        if message.startswith('/p '):
            ...
            client.send(f"Usuários online: {users}".encode())
            ...
            try:
                ...
                for sock in readable:
                    if sock == self.server:
                        ...
                        client.send("Comandos: /p usuario (chat privado), /sair (sair do privado), /lista (listar usuários)".encode())
